...
Explore
 @ajhamdi Sign out
3
21 10 alextsui05/blender-off-addon
 Code  Issues 1  Pull requests 3  Projects 0  Wiki  Insights
blender-off-addon/import_off.py
28affd9  on May 14
@markvandeveerdonk markvandeveerdonk Handle comments after first line
@alextsui05 @WeiTang114 @markvandeveerdonk
    
321 lines (280 sloc)  9.3 KB
#####
#
